...
const CareerPage = () => {
  ...
  const faqs: FAQ[] = [
    {
    "question": "What are the career outcomes for each course you offer?",
    "answer": "Full-Stack leads to roles like Web Developer or Software Engineer, AI leads to Data Scientist or ML Engineer, and Cloud leads to Cloud Engineer or DevOps Specialist."
  },
  {
    "question": "How do I choose between Full-Stack, AI, and Cloud Architecture?",
    "answer": "It depends on your interests: choose Full-Stack if you enjoy building web applications, AI if you love data and predictions, and Cloud if you're interested in infrastructure and deployment."
  },
  {
    "question": "Can I transition to a new career even if I’m from a non-tech background?",
    "answer": "Absolutely. Many of our students come from non-IT backgrounds. Our structured curriculum and mentorship make tech careers accessible to all."
  },
  {
    "question": "Do you provide career counseling or personal guidance?",
    "answer": "Yes, we offer personalized career guidance sessions to help you choose the right path and set achievable goals."
  },
  {
    "question": "How often do you update career resources based on market demand?",
    "answer": "We monitor industry trends constantly and update our learning paths and placement support materials every quarter."
  }
  ];
  ...
  try {
    ...
    const res = await fetch('https://kgpath.onrender.com/api/job-apply', {
      method: 'POST',
      body: data,
    });
