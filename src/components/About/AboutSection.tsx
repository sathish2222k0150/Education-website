          ...
          <div className="space-y-8" data-aos="fade-up">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="space-y-2" data-aos="fade-right">
                ...
                <p className="text-gray-600">To become a globally recognized platform for professional skill development empowering learners to transform their careers and shape the future of technology.</p>
              </div>
              <div className="space-y-2" data-aos="fade-left">
                <h3 className="text-xl font-semibold text-gray-900">Our Mission</h3>
                <p className="text-gray-600">To make quality tech education accessible to everyone and bridge the digital skills gap by delivering hands‑on, industry-relevant training in Full-Stack Development, AI & ML, and Cloud Computing.</p>
              </div>
            </div>
