...
interface CourseDetailsHeroProps {
  course: Course;
  onBackClick: () => void;
  onApplyNowClick: () => void; // 👈 Passed from parent
}

const CourseDetailsHero: React.FC<CourseDetailsHeroProps> = ({
  course,
  onBackClick,
  onApplyNowClick
}) => {
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex items-center space-x-4 md:space-x-6 pt-2 md:pt-4">
              ...
              <div>
                <div className="text-sm md:text-lg font-bold">{course.emi}</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4">
              <button
                onClick={onApplyNowClick} // 👈 This comes from the parent
              ...
              <button className="hover:bg-orange-500 border-2 border-white/30 text-white px-4 py-3 md:px-8 md:py-4 rounded-lg hover:bg-white/10 transition-colors font-semibold text-base md:text-lg flex items-center justify-center">
          ...
          <div className="relative mt-6 md:mt-6">
            <img 
              src={course.image}
              alt={course.title}
              className="rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl w-full h-[400px]"
            />
