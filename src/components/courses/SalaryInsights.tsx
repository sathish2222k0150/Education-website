...
const SalaryInsights: React.FC<SalaryInsightsProps> = ({ courseId }) => {
  const course = getCourseById(courseId);
  const salaryData = course?.SalarayData ?? [];
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-gray-200 rounded-2xl p-8 border border-gray-100">
