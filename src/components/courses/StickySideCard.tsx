...
interface StickySideCardProps {
  course: Course;
  onApplyClick: () => void; // 🔥 Added prop
}

const StickySideCard: React.FC<StickySideCardProps> = ({ course, onApplyClick }) => {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 sticky top-24">
      <div className="space-y-6">
        ...
        {/* Apply Now Button */}
        <button
          onClick={onApplyClick} // 🔥 Trigger passed down from parent
        ...
        <div className="border-t pt-6">
          ...
          <div className="space-y-3">
            {['Fill Application', 'Get Counselling', 'Pay Fees', 'Start Learning'].map((step, index) => (
