...
export default function TestimonialsSection() {
  ...
  const [itemsPerView, setItemsPerView] = useState(3); // default: 3 items for large screens

  // Detect screen size to set itemsPerView
  useEffect(() => {
    const updateItemsPerView = () => {
      if (window.innerWidth < 1024) { // smaller than lg
        setItemsPerView(1);
      } else {
        setItemsPerView(3);
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Our Students<span className="text-orange-500"> Testimonials </span>
          </h2>
